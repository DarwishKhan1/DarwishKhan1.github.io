                        ...
                        <div class="col-lg-5 mt-5 pt-0 pt-lg-5">
                            ...
                            <div class="pt-4 pb-4">
                                ...
                                <a href="javascript:void(0)" class="btn btn-custom btn-info btn-shadow-v1 downloadcount123 font-tofino-medium" data-toggle="modal" data-target="#download-modal">
                                    ...
                                    Free Download</a>
                                <a href="http://adminmart.com/src/html/main.html" target="_blank" class="text-decoration-none font-17 text-dark ml-4 font-tofino-medium border-bottom border-dark">Live
                                    Preview</a>
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="pt-3 pb-4">
                                <a href="javascript:void(0)" class="btn downloadcount123 btn-custom btn-info btn-shadow-v1 font-tofino-medium" data-toggle="modal" data-target="#download-modal">
                                    <i data-feather="download" class="data-icon mr-2 mb-1"></i>
                                    Free Download</a>
                                <a href="http://adminmart.com/src/html/main.html" target="_blank" class="text-decoration-none text-dark font-17 ml-4 font-tofino-medium border-bottom border-dark">Live
                                    Preview</a>
                            </div>
                        </div>
                    </div>
