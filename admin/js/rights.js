...
database.collection('websites').doc('website').get().then((docs) => {
...
database.collection("admin").doc('Pcio0nYhI4AkiNTAEDY4')
    .get()
    .then((rights) => {
...
database.collection("admin").doc('Pcio0nYhI4AkiNTAEDY4')
    ...
    .then((profle) => {
        ...
        $('#profileImg').append(`<a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
